...
<div class="container" id="content">
    <div class="row">
        <div class="col-md-6">
            <form method="POST" action="{{url('insert_book')}}">
                {{csrf_field()}}
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <input type="NumberPhone" class="form-control" id="NumberPhone" name="numberphone_book" placeholder="Enter Number Phone:(+855)">
                    </div>
                    <div class="form-group">
